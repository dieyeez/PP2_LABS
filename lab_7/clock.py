...
leftarm = pygame.image.load("lab_7/images/leftarm.png")
rightarm = pygame.image.load("lab_7/images/rightarm.png")
mainclock = pygame.transform.scale(
    pygame.image.load("lab_7/images/clock.png"), (800, 600))
...
while not done:
    ...
    rotated_leftarm = pygame.transform.rotate(
        pygame.transform.scale(leftarm, (40.95, 682.5)), -second_angle)
